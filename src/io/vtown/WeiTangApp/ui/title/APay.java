...
//    @BindView(R.id.butterknife1)
//    Button butterknife1;
//    @BindView(R.id.butterknife2)
//    Button butterknife2;
...
//        butterknife2.setOnClickListener(this);
...
//							platformName), 10*1000).show();
    ...
    protected void MyClick(View V) {
        switch (V.getId()) {
            case R.id.butterknife2:
                PromptManager.ShowCustomToast(BaseContext,"butterkinfe测试");
                break;
            case R.id.ddddwwww:
