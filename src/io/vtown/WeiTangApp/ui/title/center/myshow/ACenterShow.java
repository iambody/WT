 ...
 */
public class ACenterShow extends ATitleBase implements RefreshLayout.OnLoadListener {
    /**
     * 外层
     */
//	private PullView center_out_scrollview;
    private RefreshLayout mycenter_show_refrash;
    /**
     * head
     */
    ...
    private void IBase() {
        ...
        mycenter_show_refrash.setOnLoadListener(this);
        mycenter_show_refrash.setColorSchemeResources(R.color.app_fen, R.color.app_fen1, R.color.app_fen2, R.color.app_fen3);
...
//            center_out_scrollview.ShowFoot();
            mycenter_show_refrash.setCanLoadMore(true);
        } else {
//            center_out_scrollview.HindFoot();
            mycenter_show_refrash.setCanLoadMore(false);
        }
        ...
        switch (Data.getHttpLoadType()) {
            ...
            case LOAD_REFRESHING:
                ...
                mCenterShowAp.FrashData(listDatas, datas);
                mycenter_show_refrash.setRefreshing(false);
                break;
            case LOAD_LOADMOREING:
                if (listDatas != null && listDatas.size() > 0)
                    mCenterShowAp.AddFrashData(listDatas);

                mycenter_show_refrash.setLoading(false);
                break;
            default:
                break;
        }
