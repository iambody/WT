package io.vtown.WeiTangApp.comment.view.radiogroup;
 ...
 *
 */
public class GradualRadioGroup extends RadioGroup {
...
//    }
    private MainTabPostion mainTabPostion;
    ...
    public void SetListenerPostion(MainTabPostion result) {

        this.mainTabPostion = result;
    }
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            getChildAt(i).setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if(mainTabPostion!=null)
                    mainTabPostion.ListenerTabPostion(position);
//                    if (mViewPager != null) {
...
//    }
    ...
    public interface MainTabPostion {
