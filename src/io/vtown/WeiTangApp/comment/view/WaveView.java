...
public class WaveView extends View {
    ...
    public static final int DEFAULT_BEHIND_WAVE_COLOR =  Color.parseColor("#3c000000");;// Color.parseColor("#f16d7a");//;//Color.parseColor("#28f16d7a");//Color.parseColor("#28FFFFFF");
