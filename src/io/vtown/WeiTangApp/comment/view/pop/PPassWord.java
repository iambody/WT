	...
	BaseAdapter adapter = new BaseAdapter() {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (position == 9) {
				...
				viewHolder.btnKey.setTextColor(pContext.getResources().getColor(R.color.lightpink));
			}
			if (position == 11) {
				viewHolder.btnKey
						.setBackgroundResource(R.drawable.selector_key_del);
				viewHolder.btnKey.setTextColor(pContext.getResources().getColor(R.color.app_gray));
			}
