...
public class ImagViewDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MBNewHome = JSON.parseObject(CacheUtil.NewHome_Get(dpContext), BNewHome.class);
//		bShop = Spuit.Shop_Get(dpContext);
        ...
        pop_imagview_head_name.setText(StrUtils.NullToStr(MBNewHome.getSellerinfo()
                .getSeller_name()));
        ImageLoaderUtil.Load2(MBNewHome.getSellerinfo().getAvatar(), pop_imagview_head,
                R.drawable.testiv);
