 ...
 */
	...
	private void initialise() {
		...
		setButtonBgResource(R.drawable.select_jiajian_bt,
				R.drawable.select_jiajian_bt);

		addButton.setText("+");
		subButton.setText("-");
		addButton.setTextColor(getResources().getColor(R.color.app_gray));
		subButton.setTextColor(getResources().getColor(R.color.app_gray));
	...
	private void setTextWidthHeight() {
		...
		editText.setMinimumWidth(dip2px(context, editTextMinimumWidth + 10));
		centerLinearLayout.setMinimumWidth(dip2px(context,
				editTextMinimumWidth + 10));
		...
		if (editTextLayoutWidth > 0) {
			...
			LayoutParams layoutParams = (LayoutParams) editText
					.getLayoutParams();
			layoutParams.width = dip2px(context, editTextLayoutWidth + 10);
			editText.setLayoutParams(layoutParams);
			centerLinearLayout.setLayoutParams(layoutParams);
		}
	}
	...
	class OnButtonClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			if (numString == null || numString.equals("")) {
				...
				if (v.getTag().equals("+")) {
					if (++num < MinNumber) // 先加，再判断
					{
						num--;
						Toast.makeText(context, "亲，数量至少为" + MinNumber + "哦~",
	 ...
	 * 设置最小值
	 */
	public void SetMinNumber(int myMinNumber) {
		this.MinNumber = myMinNumber;
	}
	...
	class OnTextChangeListener implements TextWatcher {
		...
		public void afterTextChanged(Editable s) {
			...
			if (numString == null || numString.equals("")) {
				...
				if (numInt < MinNumber) {
					Toast.makeText(context, "亲，数量至少为"+MinNumber+"哦~", Toast.LENGTH_SHORT)
							.show();
					editText.setText(MinNumber+" ");
				} else {
