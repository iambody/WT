 ...
 * @version 创建时间：2016-7-18 上午11:00:11
 *  
 */
...
//     * 普通的Notification
//     */
//    public void postNotification(Context mmcontext,Activity TagerActivity) {
//        Notification.Builder builder = new Notification.Builder(context);
//        Intent intent = new Intent(mmcontext, TagerActivity);  //需要跳转指定的页面
