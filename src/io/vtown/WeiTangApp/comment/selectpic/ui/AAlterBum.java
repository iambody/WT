 ...
 * @version 创建时间：2016-7-19 下午5:48:30
 *  
 */
public class AAlterBum extends ABase {
	// 显示手机里的所有图片的列表控件
...
//				intent.setClass(BaseActivity,AGoodEditPicSelect.class);
...
//			intent.setClass(Ba, ImageFile.class);
			BaseActivity.finish();
//			startActivity(intent);
		}
		return false;
