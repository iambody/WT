package io.vtown.WeiTangApp.comment.selectpic.adapter;

import io.vtown.WeiTangApp.comment.selectpic.util.BitmapCache;
import io.vtown.WeiTangApp.comment.selectpic.util.BitmapCache.ImageCallback;
...
//			RelativeLayout.LayoutParams lp = new RelativeLayout.LayoutParams(dipToPx(20),dipToPx(20)); 
//			  
//			viewHolder.toggleButton.setLayoutParams(lp);
