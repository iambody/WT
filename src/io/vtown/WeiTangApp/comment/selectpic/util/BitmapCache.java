package io.vtown.WeiTangApp.comment.selectpic.util;
...
public class BitmapCache extends ABase {
		...
		new Thread() {
			...
			public void run() {
				...
				if (thumb == null) {
					// thumb = bitmap;
					// if (getPicType() == 1) {
					thumb = ASelectPic.bimap;
					// }
					//
					// if (getPicType() == 3) {
					// thumb = AGoodShare.bimap;
					// }
					// thumb = AGoodShow.bimap;
					// thumb = AGoodEditPicSelect.bimap;
				}
