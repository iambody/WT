...
//			final int Postion = arg0;
			...
			ImageLoaderUtil.Load22(mydatas.get(arg0).getCover(),
					holder.iv_good_pic, R.drawable.error_iv2);

			// ImageView mImageView = new ImageView(BaseContext);
			// LinearLayout.LayoutParams mLayoutParams = new
			// LinearLayout.LayoutParams(
			// LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
			// mImageView.setLayoutParams(mLayoutParams);
			// mImageView.setScaleType(ScaleType.FIT_XY);
			// holder.iv_good_pic.addView(mImageView);
			// ImageLoaderUtil.Load2(mydatas.get(arg0).getCover().trim(),
			// mImageView, R.drawable.error_iv2);
